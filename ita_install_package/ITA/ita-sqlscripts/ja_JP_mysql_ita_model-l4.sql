...
INSERT INTO A_SEQUENCE (NAME,VALUE,MENU_ID,DISP_SEQ,NOTE,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('F_MATERIAL_LINKAGE_TERRAFORM_JSQ',1,'2100150008',2100540002,'履歴テーブル用',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);

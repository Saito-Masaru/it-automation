...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100520002','F_MATERIAL_LINKAGE_ANS_JSQ',1,'2100150006','履歴テーブル用','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);

...
INSERT INTO A_SEQUENCE (NAME,VALUE,MENU_ID,DISP_SEQ,NOTE,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('F_HG_VAR_LINK_LEGACY_JSQ',1,'2100170006',2100730002,'for the history table.',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (NAME,VALUE,MENU_ID,DISP_SEQ,NOTE,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('F_HG_VAR_LINK_LEGACYROLE_JSQ',1,'2100170007',2100730004,'for the history table.',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);

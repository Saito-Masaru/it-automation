...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000161','F_MM_STATUS_MASTER_JSQ',11,'2100150005','For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000163','F_DIR_MASTER_JSQ',2,'2100150002','For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000165','F_AUTO_RETURN_JSQ',3,NULL,'For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000167','F_FILE_MASTER_JSQ',1,'2100150003','For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000169','F_FILE_MANAGEMENT_JSQ',1,'2100150101','For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000171','F_FILE_MANAGEMENT_INITIAL_JSQ',1,NULL,'For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_SEQUENCE (ID,NAME,VALUE,MENU_ID,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('2100000173','F_MATERIAL_IF_INFO_JSQ',2,'2100150001','For the history table.','0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
